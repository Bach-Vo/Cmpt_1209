/* This class defines a set of integers called MySet. Objects of the type MySet are a set including distinct integers, if they are not empty.
   ...
   This class also defines the following methods:
	 ...
	 9) The "unionWith" method creates and returns a new MySet object including all the integers of the current set and another set passed as function's input parameter.
	 10) The "intersectWith" method creates and returns the intersection of the set with another set passed in the function's input parameter. The intersection of two sets is a set including all the items that commonly exist in both sets.
